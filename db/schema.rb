...
ActiveRecord::Schema[7.0].define(version: 2022_06_20_123443) do
  ...
  create_table "sleep_records", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["sleep_clock_in_id", "wake_up_clock_in_id"], name: "index_sleep_records_on_sleep_id_and_wake_up_id", unique: true
